...
public interface TaskMapper extends BaseMapper<Task> {
     ...
     */
    List<Task> sortByTimePage(Page<Task> page, @Param("fuzzyTitle") String fuzzyTitle, String reverse);

    List<Task> sortBySenderCredit(Page<Task> page, @Param("fuzzyTitle") String fuzzyTitle, String reverse);
